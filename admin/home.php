...
<div class="navbar">
	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
			  ...
			  <h2><B>OVERVIEW</B></h2>
			  <p>Durgapur Society of Management Science is one of the reputed professional Institutes run by a voluntary organization Oriental Association for Education and Research.
			  </p>
...
<p><font color="black">
Three years full time Honors courses in BBA, BCA, BBA(HM) and BHM permanently affiliated to The University of Kazi Nazrul.
</p>	  
...
Vision Train and develop highly motivated and committed professional elementary and secondary teachers equipped with instructional,personal and social competencies conducive to teh task of human development.
	  ...
	  <div class="modal-footer">
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
			   ...
			   <h2>Objectives</h2><p>BIMS</footer>DSMS college Level</p>
